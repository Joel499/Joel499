# 💫 About Me:
I’m a **Computer Science Graduate** from **Sunway University**, specializing in **Cybersecurity and Machine Learning**.  My interests lie in **threat analysis**, **intrusion detection**, **network defense**, and **machine learning applications in security**.  I enjoy building and experimenting with security-focused projects which include **Intrusion Detection Systems (IDS)** for IoT environments to **data-driven security analytics** using Python and Scikit-learn.  My goal is to contribute to making digital systems safer and more resilient.  
...
- Certification pursuits: IBM - Penetration Testing, Threat Hunting, and Cryptography, Microsoft Azure Fundamentals (AZ-900), and (ISC)² Certified in Cybersecurity (CC)  
